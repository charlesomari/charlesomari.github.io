...
<input type="mks" name="totalstudents" id="totalstudents" required="required" placeholder="total number of student"/><br/><br />
<label>Average Math:</label>
<input type="mks" name="math" id="math" required="required" placeholder=" maths "/>
...
$sql = "INSERT INTO kcseresults ( year, totalstudents,  math, english, kiswa, physics,chemistry,cre,geography,biology,totalgrade)
VALUES ('".$_POST["year"]."','".$_POST["totalstudents"]."','".$_POST["math"]."','".$_POST["english"]."',
