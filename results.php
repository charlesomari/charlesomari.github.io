...
<label>Year :</label>
	...
	<option value"1A" input type="btn">1A</option>
	...
	<option value"4B">4B</option></select>
	<label>Term :</label>
    <select name="term" required autofocus>
	<option value"term1" input type="btn">Term 1</option>
	<option value"term2">Term 2</option>
	<option value"term3">Term 3</option></select><br /><br />
