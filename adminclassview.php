            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">LERTZ Class Teachers </h2>
                    ...
                    $sql = "SELECT * FROM classassignment";
                                ...
                                while($row = $result->fetch_array()){
                                    echo "<tr>";
                                     ...
                                     echo "<td>" . $row['teachers_name'] . "</td>";
                                        echo "<td>" . $row['class_asigned'] . "</td>";
                                        echo "<td>";
                                            echo "<a href='classteacherdelete.php?id=". $row['id'] ."' title='delete Record' 
