...
<label>Term :</label>
<input type="text" name="term" id="term" required="required" placeholder="Please Enter the stream"/><br /><br />
 <label> Tuition  :</label>
<input type="text" name="tuition" id="tuition" required="required" placeholder="enter tuition amount"/><br/><br />
<label>Food:</label>
<input type="text" name="food" id="food" required="required" placeholder="Please enter the tuition amount"/><br/><br />
<label>Others:</label>
...
$sql = "INSERT INTO fees ( term, tuition,food,others,total)
VALUES ('".$_POST["term"]."','".$_POST["tuition"]."','".$_POST["food"]."','".$_POST["others"]."','".$_POST["total"]."')";

if ($conn->query($sql) === TRUE) {
echo "<script type= 'text/javascript'>alert('New fee structure  uploaded successfully');</script>";
} else {
